...
namespace HammerDrop_Auction_app.Migrations
{
    ...
    [Migration("20250813055909_AddBidModelAndAdsChanges")]
    partial class AddBidModelAndAdsChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HammerDrop_Auction_app.Entities.Ad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EnableProxyBidding")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("ProxyMaxBid")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HammerDrop_Auction_app.Entities.AdImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HammerDrop_Auction_app.Entities.Bid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HammerDrop_Auction_app.Entities.AdImages", b =>
                {
                    b.HasOne("HammerDrop_Auction_app.Entities.Ad", "Ad")
                        .WithMany("Images")
                        .HasForeignKey("AdId")
            ...
            modelBuilder.Entity("HammerDrop_Auction_app.Entities.Bid", b =>
                {
                    ...
                    b.HasOne("HammerDrop_Auction_app.Entities.UserAccount", "UserAccount")
                        .WithMany()
